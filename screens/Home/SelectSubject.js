...
import { baseUrl, admobAdBanner, admobInterestial, admobRewardedInterestial } from "../../constants/global";
import { InterstitialAd, AdEventType, TestIds, useRewardedInterstitialAd } from 'react-native-google-mobile-ads';
...
const SelectSubject = (props) => {
  ...
  const [selectedFilterSubject, setSelectedFilterSubject] =
    useState("All");
                        ...
                        {section.title}
                         ...
                         renderItem={({ item:subSection, index:subIndex }) => (
                            ...
                            {subSection.title !== section.title && (
                              <Text
                                style={styles.subsection_text}
                              >
                                {subSection.title}
                              </Text>
                            )}
                             <View
                              style={styles.subsection_container}
                            >
                              <FlatList                                 
                                ...
                                keyExtractor={({item:subject, index:subject_index}) => `subject-${subject_index}`}
...
export default connect(mapStateToProps, { logout, rewardedShown })(SelectSubject);
